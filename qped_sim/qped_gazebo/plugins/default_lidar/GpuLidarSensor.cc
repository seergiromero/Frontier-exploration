...
bool GpuLidarSensor::Load(const sdf::Sensor &_sdf)
{
  ...
  msgs::InitPointCloudPacked(this->dataPtr->pointMsg, this->FrameId(), true,
      {{"xyz", msgs::PointCloudPacked::Field::FLOAT32},
       ...
       {"time", msgs::PointCloudPacked::Field::FLOAT32}});
...
//////////////////////////////////////////////////
void GpuLidarSensorPrivate::FillPointCloudMsg(const float *_laserBuffer, const std::chrono::steady_clock::duration &timeDiff)
{
