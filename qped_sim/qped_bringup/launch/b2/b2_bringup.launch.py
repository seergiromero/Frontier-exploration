...
# =================================================================
    ...
    # World
    # world_path=os.path.join(get_package_share_directory('qped_gazebo'), 'worlds', 'ground_plane.sdf')
    world_path=os.path.join(get_package_share_directory('qped_gazebo'), 'worlds', 'scenario.sdf')
    #world_path=os.path.join(get_package_share_directory('qped_gazebo'), 'worlds', 'indoor_scenario.sdf')
...
# =================================================================
    ...
    ros_gz_bridge = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([os.path.join(
            get_package_share_directory('qped_bringup'), 'launch'), '/b2/b2_gz_bridge.launch.py'
            ]),
        )
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([
                os.path.join(get_package_share_directory('qped_bringup'), 'launch/common', 'gz_sim.launch.py')
                ]),
